...
void test_partitioning() {
    ...
    env.spawn(N * N, [](auto& world_) {
            // Hack to get bulk::epiphany::world::log
            // instead of  bulk::world::log
            // because printf-family is broken on epiphany
            bulk::epiphany::world& world = *(bulk::epiphany::world*)&world_;
        ...
        BULK_FINALIZE_TESTS("Partitionings");
    });
}
