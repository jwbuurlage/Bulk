...
///**
// * A irregular block distribution. This unequally block-distributes the first G
// * axes.
// */
//class irregular_block_partitioning : public rectangular_partitioning<1, 1> {
//  public:
//    using rectangular_partitioning<1, 1>::local_size;
//    using rectangular_partitioning<1, 1>::origin;
//    using rectangular_partitioning<1, 1>::local_to_global;
//
//    /**
//     * Constructs an irregular block partitioning in nD.
//     *
//     * `grid`: the number of processors in each dimension
//     * `data_size`: the global number of processors along each axis
//     * `axes`: an array of size `G` that indicates the axes over which to
...
//     */
//    block_partitioning(index_type<D> data_size, index_type<G> grid,
//                       index_type<G> axes, index_type<G> block_sizes)
//        : rectangular_partitioning<D, G>(data_size, grid), axes_(axes) {
//        static_assert(G <= D,
//                      "Dimensionality of the data should be larger or equal to "
//                      "that of the processor grid.");
